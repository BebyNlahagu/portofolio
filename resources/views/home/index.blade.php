...
<head>
    ...
    <title>Beby Nosderita Lahagu</title>
    ...
    <link href="{{ asset('package/css/style.css') }}" rel="stylesheet" media="screen">
</head>
...
<body>
    <div class="animsition">
        ...
        <header class="navbar boxed">
            ...
            <a class="brand" href="#">
                <img class="brand-img" alt="" src="{{ asset('package/images/23.jpg') }}">
                <div class="brand-info">
                    <div class="brand-name">Beby Lahagu</div>
            ...
            <div class="contacts d-none d-md-block">
                ...
                <div class="contact-item">
                    Bebynlahagu20@gmail.com
                </div>
            </div>
        </header>
        <div class="copy-bottom white boxed">© Beby 2023.</div>
        ...
        <div class="pagepiling">
            <div data-anchor="page1" class="pp-scrollable text-white section section-1">
                <div class="scroll-wrap">
                    <div class="section-bg" style="background-image:url(package/images/bg/23.jpg);"></div>
                    <div class="scrollable-content">
                        <div class="vertical-centred">
                            <div class="boxed boxed-inner">
                                <div class="vertical-title d-none d-lg-block"><span>selamat Datang</span></div>
                                <div class="boxed">
                                    <div class="container">
                                        <div class="intro">
                                            <div class="row">
                                                <div class="col-md-8 col-lg-6">
                                                    <p class="subtitle-top">Selamat Datang <br>Bang Beby</p>
                                                    <h1 class="display-2 text-white"><span
                                                            class="text-primary">Hallo</span> Saya <br> Beby N. Lahagu.</h1>
                                                    <a href="#"
                                                    ...
                                                    <div class="progress-bars">
                                                        ...
                                                        <div class="progress">
                                                            <div class="progress-bar" role="progressbar"
                                                                style="width: 80%" aria-valuenow="0"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="col-resume">
                                                        ...
                                                        <div class="resume-content">
                                                            <div class="resume-inner">
                                                                <div class="resume-row">
                                                                    <h6 class="resume-type">Webdesigner & Front-end
                                                                    </h6>
                                                                    <p class="resume-study">University of studies,
                                                                        Poland, Cracow</p>
                                                                    <p class="resume-date text-primary">Jan 2004 - Dec
                                            ...
                                            <div class="row row-partners">
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt=""
                                                            src="images/partners/1.png"></div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt=""
                                                            src="images/partners/2.png"></div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt=""
                                                            src="images/partners/3.png"></div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt=""
                                                            src="images/partners/4.png"></div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt=""
                                                            src="images/partners/5.png"></div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt=""
                                                            src="images/partners/6.png"></div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt=""
                                                            src="images/partners/7.png"></div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt=""
                                                            src="images/partners/8.png"></div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt=""
                                                            src="images/partners/9.png"></div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt=""
                                                            src="images/partners/10.png"></div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt=""
                                                            src="images/partners/11.png"></div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt=""
                                                            src="images/partners/12.png"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <a href="#" class="h5 link-arrow text-white">view all
                                                        projects <i class="icon icon-chevron-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h2 class="title-uppercase"><span class="text-primary">NEW
                                                            YORK</span>,USA</h2>
                                                    <h5 class="text-muted">166 Main Street, Beverly Hills, CA 90210
                                                    </h5>
                                                    <section class="contact-address">
                                                        <h3><a class="mail"
                                                                href="http://paul-themes.com/cdn-cgi/l/email-protection#74171b1a0015170034061b161106005a171b19">
                                                                <span class="__cf_email__"
                                                                    data-cfemail="791a16170d181a0d390b161b1c0b0d571a1614">[email&#160;protected]</span></a>
                                                        </h3>
                                                        ...
                                                        <form class="js-form" novalidate="novalidate">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group form-group-message col-sm-12">
                                                                    <span id="success" class="text-primary">Thank
                                                                        You, your message is successfully sent!</span>
    ...
    <script src="{{ asset('package/js/jquery.min.js') }}"></script>
    <script src="{{ asset('package/js/wow.min.js') }}"></script>
    <script src="{{ asset('package/js/smoothscroll.js') }}"></script>
    <script src="{{ asset('package/js/animsition.js') }}"></script>
    <script src="{{ asset('package/js/jquery.validate.min.js') }}"></script>
    <script src="{{ asset('package/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('package/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('package/js/jquery.pagepiling.min.js') }}"></script>

    <script src="{{ asset('package/js/scripts.js') }}"></script>
</body>
